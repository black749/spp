...
int main(int argc, char **argv)
{
    ...
    n = 2;
    char* infile[] = {
        {"E:\\2023RTKLIB\\data\\cmum2440.22o"},
        {"E:\\2023RTKLIB\\data\\BRDC00IGS_R_20222440000_01D_MN.rnx"}
    };
    char* outfile = { "E:\\2023RTKLIB\\cmum2440.pos" };
    sprintf(filopt.stapos, "E:\\2023RTKLIB\\data\\test_PPP\\data\\snx\\igs2225.snx");
